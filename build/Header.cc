...
Header_tmp_stream<<"\n";
	Header_tmp_stream << "<button onclick=\"location.href='/login'\" class=\"btn btn-outline-primary me-2\">Login</button>\n";
Header_tmp_stream<<"\n";
	Header_tmp_stream << "<button onclick=\"location.href='/sign-up'\"type=\"button\" class=\"btn btn-primary\">Sign-up</button>\n";
	Header_tmp_stream << "</div>\n";
